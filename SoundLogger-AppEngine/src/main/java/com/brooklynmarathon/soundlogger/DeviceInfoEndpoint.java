...
import com.brooklynmarathon.soundlogger.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "brooklynmarathon.com", ownerName = "brooklynmarathon.com", packagePath = "soundlogger"))
